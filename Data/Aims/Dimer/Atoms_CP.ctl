...
H_0             <PATH1>/Atoms_CP          H_0            energy 
He_0            <PATH1>/Atoms_CP          He_0           energy 
# Period 2'th-(Main elements)
Li_0            <PATH1>/Atoms_CP          Li_0           energy 
Be_0            <PATH1>/Atoms_CP          Be_0           energy 
B_0             <PATH1>/Atoms_CP          B_0            energy 
C_0             <PATH1>/Atoms_CP          C_0            energy 
N_0             <PATH1>/Atoms_CP          N_0            energy 
O_0             <PATH1>/Atoms_CP          O_0            energy 
F_0             <PATH1>/Atoms_CP          F_0            energy 
Ne_0            <PATH1>/Atoms_CP          Ne_0           energy 
# Period 3'th-(Main elements)
Na_0            <PATH1>/Atoms_CP          Na_0           energy 
Mg_0            <PATH1>/Atoms_CP          Mg_0           energy 
Al_0            <PATH1>/Atoms_CP          Al_0           energy 
Si_0            <PATH1>/Atoms_CP          Si_0           energy 
P_0             <PATH1>/Atoms_CP          P_0            energy 
S_0             <PATH1>/Atoms_CP          S_0            energy 
Cl_0            <PATH1>/Atoms_CP          Cl_0           energy 
Ar_0            <PATH1>/Atoms_CP          Ar_0           energy 
# Period 4'th-(Main elements)
Cu_0            <PATH1>/Atoms_CP          Cu_0           energy 
Zn_0            <PATH1>/Atoms_CP          Zn_0           energy 
