...
#"Flag"         "DIR"                         "InpName"       "JobType"
 C6H6           <PATH1>/bz2s_scan             ben.in         energy
# 118 points in Bz2 PESs
# Sandwich
 s32            <PATH1>/bz2s_scan            s1.in            energy
 s33            <PATH1>/bz2s_scan            s2.in            energy
 s34            <PATH1>/bz2s_scan            s3.in            energy
 s35            <PATH1>/bz2s_scan            s4.in            energy
 s36            <PATH1>/bz2s_scan            s5.in            energy
 s37            <PATH1>/bz2s_scan            s6.in            energy
 s38            <PATH1>/bz2s_scan            s7.in            energy
 s39            <PATH1>/bz2s_scan            s8.in            energy
 s40            <PATH1>/bz2s_scan            s9.in            energy
 s41            <PATH1>/bz2s_scan           s10.in            energy
 s42            <PATH1>/bz2s_scan           s11.in            energy
 s45            <PATH1>/bz2s_scan           s12.in            energy
 s50            <PATH1>/bz2s_scan           s13.in            energy
 s55            <PATH1>/bz2s_scan           s14.in            energy
 s60            <PATH1>/bz2s_scan           s15.in            energy
 s65            <PATH1>/bz2s_scan           s16.in            energy
# T-Shape
 t44            <PATH1>/bz2t_scan            t1.in            energy
 t45            <PATH1>/bz2t_scan            t2.in            energy
 t46            <PATH1>/bz2t_scan            t3.in            energy
 t47            <PATH1>/bz2t_scan            t4.in            energy
 t48            <PATH1>/bz2t_scan            t5.in            energy
 t49            <PATH1>/bz2t_scan            t6.in            energy
 t50            <PATH1>/bz2t_scan            t7.in            energy
 t51            <PATH1>/bz2t_scan            t8.in            energy
 t52            <PATH1>/bz2t_scan            t9.in            energy
 t53            <PATH1>/bz2t_scan           t10.in            energy
 t54            <PATH1>/bz2t_scan           t11.in            energy
 t55            <PATH1>/bz2t_scan           t12.in            energy
 t56            <PATH1>/bz2t_scan           t13.in            energy
 t59            <PATH1>/bz2t_scan           t14.in            energy
 t64            <PATH1>/bz2t_scan           t15.in            energy
 t69            <PATH1>/bz2t_scan           t16.in            energy
 t74            <PATH1>/bz2t_scan           t17.in            energy
 t79            <PATH1>/bz2t_scan           t18.in            energy
# Parallel-Shape-D32
 pd32L20        <PATH1>/bz2pd_32_scan       pA1.in            energy
 pd32L18        <PATH1>/bz2pd_32_scan       pA2.in            energy
 pd32L16        <PATH1>/bz2pd_32_scan       pA3.in            energy
 pd32L14        <PATH1>/bz2pd_32_scan       pA4.in            energy
 pd32L12        <PATH1>/bz2pd_32_scan       pA5.in            energy
 pd32L10        <PATH1>/bz2pd_32_scan       pA6.in            energy
 pd32L08        <PATH1>/bz2pd_32_scan       pA7.in            energy
 pd32L06        <PATH1>/bz2pd_32_scan       pA8.in            energy
 pd32L04        <PATH1>/bz2pd_32_scan       pA9.in            energy
 pd32L02        <PATH1>/bz2pd_32_scan      pA10.in            energy
 pd32L00        <PATH1>/bz2s_scan            s1.in            energy
 pd32R02        <PATH1>/bz2pd_32_scan      pA10.in            energy
 pd32R04        <PATH1>/bz2pd_32_scan       pA9.in            energy
 pd32R06        <PATH1>/bz2pd_32_scan       pA8.in            energy
 pd32R08        <PATH1>/bz2pd_32_scan       pA7.in            energy
 pd32R10        <PATH1>/bz2pd_32_scan       pA6.in            energy
 pd32R12        <PATH1>/bz2pd_32_scan       pA5.in            energy
 pd32R14        <PATH1>/bz2pd_32_scan       pA4.in            energy
 pd32R16        <PATH1>/bz2pd_32_scan       pA3.in            energy
 pd32R18        <PATH1>/bz2pd_32_scan       pA2.in            energy
 pd32R20        <PATH1>/bz2pd_32_scan       pA1.in            energy
# Parallel-Shape-D34
 pd34L20        <PATH1>/bz2pd_34_scan       pB1.in            energy
 pd34L18        <PATH1>/bz2pd_34_scan       pB2.in            energy
 pd34L16        <PATH1>/bz2pd_34_scan       pB3.in            energy
 pd34L14        <PATH1>/bz2pd_34_scan       pB4.in            energy
 pd34L12        <PATH1>/bz2pd_34_scan       pB5.in            energy
 pd34L10        <PATH1>/bz2pd_34_scan       pB6.in            energy
 pd34L08        <PATH1>/bz2pd_34_scan       pB7.in            energy
 pd34L06        <PATH1>/bz2pd_34_scan       pB8.in            energy
 pd34L04        <PATH1>/bz2pd_34_scan       pB9.in            energy
 pd34L02        <PATH1>/bz2pd_34_scan      pB10.in            energy
 pd34L00        <PATH1>/bz2s_scan            s3.in            energy
 pd34R02        <PATH1>/bz2pd_34_scan      pB10.in            energy
 pd34R04        <PATH1>/bz2pd_34_scan       pB9.in            energy
 pd34R06        <PATH1>/bz2pd_34_scan       pB8.in            energy
 pd34R08        <PATH1>/bz2pd_34_scan       pB7.in            energy
 pd34R10        <PATH1>/bz2pd_34_scan       pB6.in            energy
 pd34R12        <PATH1>/bz2pd_34_scan       pB5.in            energy
 pd34R14        <PATH1>/bz2pd_34_scan       pB4.in            energy
 pd34R16        <PATH1>/bz2pd_34_scan       pB3.in            energy
 pd34R18        <PATH1>/bz2pd_34_scan       pB2.in            energy
 pd34R20        <PATH1>/bz2pd_34_scan       pB1.in            energy
# Parallel-Shape-D36
 pd36L20        <PATH1>/bz2pd_36_scan       pC1.in            energy
 pd36L18        <PATH1>/bz2pd_36_scan       pC2.in            energy
 pd36L16        <PATH1>/bz2pd_36_scan       pC3.in            energy
 pd36L14        <PATH1>/bz2pd_36_scan       pC4.in            energy
 pd36L12        <PATH1>/bz2pd_36_scan       pC5.in            energy
 pd36L10        <PATH1>/bz2pd_36_scan       pC6.in            energy
 pd36L08        <PATH1>/bz2pd_36_scan       pC7.in            energy
 pd36L06        <PATH1>/bz2pd_36_scan       pC8.in            energy
 pd36L04        <PATH1>/bz2pd_36_scan       pC9.in            energy
 pd36L02        <PATH1>/bz2pd_36_scan      pC10.in            energy
 pd36L00        <PATH1>/bz2s_scan            s5.in            energy
 pd36R02        <PATH1>/bz2pd_36_scan      pC10.in            energy
 pd36R04        <PATH1>/bz2pd_36_scan       pC9.in            energy
 pd36R06        <PATH1>/bz2pd_36_scan       pC8.in            energy
 pd36R08        <PATH1>/bz2pd_36_scan       pC7.in            energy
 pd36R10        <PATH1>/bz2pd_36_scan       pC6.in            energy
 pd36R12        <PATH1>/bz2pd_36_scan       pC5.in            energy
 pd36R14        <PATH1>/bz2pd_36_scan       pC4.in            energy
 pd36R16        <PATH1>/bz2pd_36_scan       pC3.in            energy
 pd36R18        <PATH1>/bz2pd_36_scan       pC2.in            energy
 pd36R20        <PATH1>/bz2pd_36_scan       pC1.in            energy
# Parallel-Shape-D38
 pd38L20        <PATH1>/bz2pd_38_scan       pD1.in            energy
 pd38L18        <PATH1>/bz2pd_38_scan       pD2.in            energy
 pd38L16        <PATH1>/bz2pd_38_scan       pD3.in            energy
 pd38L14        <PATH1>/bz2pd_38_scan       pD4.in            energy
 pd38L12        <PATH1>/bz2pd_38_scan       pD5.in            energy
 pd38L10        <PATH1>/bz2pd_38_scan       pD6.in            energy
 pd38L08        <PATH1>/bz2pd_38_scan       pD7.in            energy
 pd38L06        <PATH1>/bz2pd_38_scan       pD8.in            energy
 pd38L04        <PATH1>/bz2pd_38_scan       pD9.in            energy
 pd38L02        <PATH1>/bz2pd_38_scan      pD10.in            energy
 pd38L00        <PATH1>/bz2s_scan            s7.in            energy
 pd38R02        <PATH1>/bz2pd_38_scan      pD10.in            energy
 pd38R04        <PATH1>/bz2pd_38_scan       pD9.in            energy
 pd38R06        <PATH1>/bz2pd_38_scan       pD8.in            energy
 pd38R08        <PATH1>/bz2pd_38_scan       pD7.in            energy
 pd38R10        <PATH1>/bz2pd_38_scan       pD6.in            energy
 pd38R12        <PATH1>/bz2pd_38_scan       pD5.in            energy
 pd38R14        <PATH1>/bz2pd_38_scan       pD4.in            energy
 pd38R16        <PATH1>/bz2pd_38_scan       pD3.in            energy
 pd38R18        <PATH1>/bz2pd_38_scan       pD2.in            energy
 pd38R20        <PATH1>/bz2pd_38_scan       pD1.in            energy
