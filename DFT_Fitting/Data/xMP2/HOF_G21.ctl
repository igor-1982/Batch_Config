...
__optimization job__ :: xMP2

__optimization function__ :: update_qchem_xmp2.py

# $rem group of Q-Chem Package. Here 1 is for parallel version of QChem
#                                    0 is for series version of QChem
__qchem__ ::   1  # Following lines are machine and option keywords of QChem-Softs
$rem
mem_static = 200
mem_total  = 7500
exchange = gen
...
# Atoms  15
 H_0            <PATH1>/EAtom                 H_0.in          xMP2 
# He_0           <PATH1>/EAtom                He_0.in          xMP2 
 Li_0           <PATH1>/EAtom                 Li_0.in         xMP2 
 Be_0           <PATH1>/EAtom                 Be_0.in         xMP2 
 B_0            <PATH1>/EAtom                 B_0.in          xMP2 
 C_0            <PATH1>/EAtom                 C_0.in          xMP2 
 N_0            <PATH1>/EAtom                 N_0.in          xMP2 
 O_0            <PATH1>/EAtom                 O_0.in          xMP2 
 F_0            <PATH1>/EAtom                 F_0.in          xMP2 
# Ne_0           <PATH1>/EAtom                Ne_0.in          xMP2 
 Na_0           <PATH1>/EAtom                 Na_0.in         xMP2 
 Mg_0           <PATH1>/EAtom                 Mg_0.in         xMP2 
 Al_0           <PATH1>/EAtom                 Al_0.in         xMP2 
 Si_0           <PATH1>/EAtom                 Si_0.in         xMP2 
 P_0            <PATH1>/EAtom                 P_0.in          xMP2 
 S_0            <PATH1>/EAtom                 S_0.in          xMP2 
 Cl_0           <PATH1>/EAtom                 Cl_0.in         xMP2 
# G2-1 set 56
 G2-1           <PATH2>/G2                    G2-1.in         xMP2 
 G2-2           <PATH2>/G2                    G2-2.in         xMP2 
 G2-3           <PATH2>/G2                    G2-3.in         xMP2 
 G2-4           <PATH2>/G2                    G2-4.in         xMP2 
 G2-5           <PATH2>/G2                    G2-5.in         xMP2 
 G2-6           <PATH2>/G2                    G2-6.in         xMP2 
 G2-7           <PATH2>/G2                    G2-7.in         xMP2 
 G2-8           <PATH2>/G2                    G2-8.in         xMP2 
 G2-9           <PATH2>/G2                    G2-9.in         xMP2 
 G2-10          <PATH2>/G2                    G2-10.in	      xMP2 
 G2-11          <PATH2>/G2                    G2-11.in	      xMP2  
 G2-12          <PATH2>/G2                    G2-12.in	      xMP2  
 G2-13          <PATH2>/G2                    G2-13.in	      xMP2  
 G2-14          <PATH2>/G2                    G2-14.in	      xMP2  
 G2-15          <PATH2>/G2                    G2-15.in	      xMP2  
 G2-16          <PATH2>/G2                    G2-16.in	      xMP2  
 G2-17          <PATH2>/G2                    G2-17.in	      xMP2  
 G2-18          <PATH2>/G2                    G2-18.in	      xMP2  
 G2-19          <PATH2>/G2                    G2-19.in	      xMP2  
 G2-20          <PATH2>/G2                    G2-20.in	      xMP2  
 G2-21          <PATH2>/G2                    G2-21.in	      xMP2  
 G2-22          <PATH2>/G2                    G2-22.in	      xMP2  
 G2-23          <PATH2>/G2                    G2-23.in	      xMP2  
 G2-24          <PATH2>/G2                    G2-24.in	      xMP2  
 G2-25          <PATH2>/G2                    G2-25.in	      xMP2  
 G2-26          <PATH2>/G2                    G2-26.in	      xMP2  
 G2-27          <PATH2>/G2                    G2-27.in	      xMP2  
 G2-28          <PATH2>/G2                    G2-28.in	      xMP2  
 G2-29          <PATH2>/G2                    G2-29.in	      xMP2  
 G2-30          <PATH2>/G2                    G2-30.in	      xMP2  
 G2-31          <PATH2>/G2                    G2-31.in	      xMP2  
 G2-32          <PATH2>/G2                    G2-32.in	      xMP2  
 G2-33          <PATH2>/G2                    G2-33.in	      xMP2  
 G2-34          <PATH2>/G2                    G2-34.in	      xMP2  
 G2-35          <PATH2>/G2                    G2-35.in	      xMP2  
 G2-36          <PATH2>/G2                    G2-36.in	      xMP2  
 G2-37          <PATH2>/G2                    G2-37.in	      xMP2  
 G2-38          <PATH2>/G2                    G2-38.in	      xMP2  
 G2-39          <PATH2>/G2                    G2-39.in	      xMP2  
 G2-40          <PATH2>/G2                    G2-40.in	      xMP2  
 G2-41          <PATH2>/G2                    G2-41.in	      xMP2  
 G2-42          <PATH2>/G2                    G2-42.in	      xMP2  
 G2-43          <PATH2>/G2                    G2-43.in	      xMP2  
 G2-44          <PATH2>/G2                    G2-44.in	      xMP2  
 G2-45          <PATH2>/G2                    G2-45.in	      xMP2  
 G2-46          <PATH2>/G2                    G2-46.in	      xMP2  
 G2-47          <PATH2>/G2                    G2-47.in	      xMP2  
 G2-48          <PATH2>/G2                    G2-48.in	      xMP2  
 G2-49          <PATH2>/G2                    G2-49.in	      xMP2  
 G2-50          <PATH2>/G2                    G2-50.in	      xMP2  
 G2-51          <PATH2>/G2                    G2-51.in	      xMP2  
 G2-52          <PATH2>/G2                    G2-52.in	      xMP2  
 G2-53          <PATH2>/G2                    G2-53.in	      xMP2  
 G2-54          <PATH2>/G2                    G2-54.in	      xMP2  
 G2-55          <PATH2>/G2                    G2-55.in	      xMP2  
 G2-136	        <PATH2>/G2                    G2-136.in       xMP2  
